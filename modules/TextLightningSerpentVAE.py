...
def prep_text_dataset(config: Dict,tokenizer) -> Tuple[DataLoader, DataLoader, DataLoader]:
  ...
  train_dataloader = DataLoader(dataset = ResumableIterableDataset(train_texts),
  ...
  test_dataloader = DataLoader(dataset = ResumableIterableDataset(test_texts),
                               batch_size = config["batch_size"],
                               shuffle = False,
                               collate_fn = collate,
                               num_workers = dataloader_num_workers,
  ...
  val_dataloader = DataLoader(dataset = ResumableIterableDataset(val_texts),
                              batch_size = config["batch_size"],
                              shuffle = False,
                              collate_fn = collate,
                              num_workers = dataloader_num_workers,

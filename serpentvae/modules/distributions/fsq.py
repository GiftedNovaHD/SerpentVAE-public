...
# Adapt the lucidrains implementation of FSQ to work with SerpentVAE
from vector_quantize_pytorch import FSQ

class FSQDistribution(nn.Module): 
  """
  This class implements the FSQ distribution originally proposed in: 
  [Finite Scalar Quantization: VQ-VAE Made Simple](https://arxiv.org/abs/2309.15505)

  NOTE: This is a modified version of the FSQ implementation from lucidrains. 
  """
  def __init__(self, 
               levels: List[int],
               hidden_dim: int,
               ...
               num_codebooks: int,
               keep_num_codebooks_dim: Optional[bool],
               scale: Optional[float],
               device: torch.device,
               dtype: torch.dtype
              ):
    super(FSQDistribution, self).__init__()
    ...
    self.finite_scalar_quantizer = FSQ(levels = levels, 
                                       dim = latent_dim, 
